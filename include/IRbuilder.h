...
public:
  ...
  CmpInst *create_fcmp_oeq(Value *lhs, Value *rhs) {
    return CmpInst::create_fcmp(CmpInst::EQ, lhs, rhs, this->BB_);
  }
  CmpInst *create_fcmp_one(Value *lhs, Value *rhs) {
    return CmpInst::create_fcmp(CmpInst::NE, lhs, rhs, this->BB_);
  }
  CmpInst *create_fcmp_ogt(Value *lhs, Value *rhs) {
    return CmpInst::create_fcmp(CmpInst::GT, lhs, rhs, this->BB_);
  }
  CmpInst *create_fcmp_oge(Value *lhs, Value *rhs) {
    return CmpInst::create_fcmp(CmpInst::GE, lhs, rhs, this->BB_);
  }
  CmpInst *create_fcmp_olt(Value *lhs, Value *rhs) {
    return CmpInst::create_fcmp(CmpInst::LT, lhs, rhs, this->BB_);
  }
  CmpInst *create_fcmp_ole(Value *lhs, Value *rhs) {
    return CmpInst::create_fcmp(CmpInst::LE, lhs, rhs, this->BB_);
  }
